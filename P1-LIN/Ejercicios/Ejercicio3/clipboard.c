...
/*
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ sudo insmod clipboard.ko
[sudo] contraseña para kernel: 
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ echo "vivan los gatitos" > /proc/clipboard 
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ echo "art" > /proc/clipboard 
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ cat /proc/clipboard 
art
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ cat /proc/clipboard 
art
kernel@debian:~/Documentos/P1-LIN/Ejercicios/Ejercicio3$ echo "vivan los gatitos" > /proc/clipboard 
